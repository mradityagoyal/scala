...
//
//
//final class TransactionsTable(tag: Tag) extends Table[TransactionsRow](tag, "TRANSACTIONS") {
//
...
//    stringAcctType => AccountType.fromString(stringAcctType)
//  )
//
...
//  def * = (id, symbol, action, quantity, price, amount, date, commission, description, accountType, owner).mapTo[TransactionsRow]
//
//}
